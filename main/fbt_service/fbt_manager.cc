...
#include "fbt_repeater/fbt_audio_repeater.h"
#include "fbt_transport/fbt_http.h"
#include "fbt_transport/fbt_mqtt_server.h"
#include "fbt_transport/fbt_phone_transport.h"
#include "fbt_transport/fbt_voice_transport.h"
#include <esp_log.h>
...
void FbtManager::closeSession() {
    ...
    auto display_ = board_.GetDisplay();
    if (display_) {
        switch (event_) {
            case kEventPhone:
                display_->SetChatMessage("FBT", Lang::Strings::FBT_PHONE_CLOSED);
                break;
            default:
                break;
        }
